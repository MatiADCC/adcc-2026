...
export default function ADCCWorldChampionship2026Site() {
  ...
  alt="ADCC 2026"
  className="mx-auto lg:mx-0 w-full max-w-md mb-8"
/>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/75 sm:text-xl">
                ADCC World Championship 2026 brings the sport’s biggest names, the strongest international attention, and a championship atmosphere built for a massive live audience.
              </p>
              ...
              <div className="mt-10 rounded-[2rem] border border-amber-400/25 bg-gradient-to-r from-amber-400/10 to-white/[0.03] p-6 backdrop-blur-xl">
                <div className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-300 text-center">
                  Countdown to ADCC World Championship 2026
                </div>

                <div className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-4">
                  {countdownItems.map((item) => (
                    <div key={item.label} className="rounded-2xl border border-white/10 bg-black/50 p-4 text-center">
                      <div className="text-3xl font-black uppercase text-white">{item.value}</div>
                      <div className="mt-2 text-xs uppercase tracking-[0.25em] text-white/45">{item.label}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section id="worlds" className="border-b border-white/10">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Main Event</div>
              <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                ADCC World Championship 2026
              </h2>
              <p className="mt-6 text-lg leading-8 text-white/75">
                This is the highest stage in submission grappling. The best athletes in the world, one championship platform, and a weekend designed to feel bigger, louder, and more legendary than ever.
              </p>
            </div>

            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              {[
                ['Elite Line-Up', 'Champions, invited stars, and top-level competitors ready to fight for the most respected title in the sport.'],
                ['Massive Production', 'A world-class event setup created for the live crowd, premium visuals, and unforgettable broadcast moments.'],
                ['Global Attention', 'Fans, media, brands, and athletes from around the world focused on one championship stage.'],
              ].map(([title, text]) => (
                <div key={title} className="rounded-[2rem] border border-white/10 bg-gradient-to-b from-white/8 to-white/[0.03] p-7 backdrop-blur-sm">
        ...
        <section id="amateur" className="border-b border-white/10 bg-white/[0.02]">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">For The Next Generation</div>
                <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                  ADCC Amateur World Championship
                </h2>
                <p className="mt-6 text-lg leading-8 text-white/75">
                  The amateur championship expands the experience far beyond one event. It brings ambitious athletes from around the world into the ADCC ecosystem and creates an even bigger festival of grappling in the host city.
                </p>
                <p className="mt-4 text-base leading-8 text-white/65">
                  More competitors, more teams, more families, more community, and more energy around the biggest brand in submission grappling.
                </p>
              </div>
        ...
        <section id="city" className="border-b border-white/10 bg-white/[0.02]">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Host City</div>
              <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                Kraków is ready for the world
              </h2>
              <p className="mt-6 text-lg leading-8 text-white/75">
                Kraków is one of the most recognizable cities in Poland and one of the country’s strongest destinations for international events, tourism, and premium live experiences. The wider Kraków metropolitan area is home to over 1 million people, creating a strong local audience base and urban scale. With a large metropolitan population, global visibility, and a strong hospitality base, it is the perfect stage for ADCC World Championship 2026.
              </p>
            </div>

            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              {[
                ['Global Destination', 'A city known across Europe for culture, tourism, history, and major international events.'],
                ['Big-City Energy', 'A strong metropolitan area with the scale, atmosphere, and audience potential needed for a global championship weekend.'],
                ['Perfect Event Backdrop', 'Historic identity combined with modern infrastructure creates a unique host-city experience for athletes and fans.'],
              ].map(([title, text]) => (
                <div key={title} className="rounded-[2rem] border border-white/10 bg-black/60 p-7 backdrop-blur-xl">
                  <h3 className="text-2xl font-black uppercase">{title}</h3>
                  <p className="mt-4 text-sm leading-7 text-white/70">{text}</p>
                </div>
              ))}
  ...
  <div className="mx-auto max-w-7xl px-6 py-20">
    <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr]">
      <div>
        ...
        <p className="mt-6 text-lg leading-8 text-white/75">
          ...
          combat sports spectacle. TAURON Arena gives ADCC the scale, atmosphere, and visual
          impact required for a true world championship presentation.
        </p>
      </div>
      ...
      <div className="flex justify-center">
        <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-black/70 shadow-2xl shadow-black/40 backdrop-blur-xl">
          <div className="w-full bg-black flex justify-center">
            <video
              className="w-full max-w-[3840px] aspect-[16/9] object-cover"
              autoPlay
              muted
              loop
              playsInline
    ...
    <div className="mt-12 grid gap-6 lg:grid-cols-3">
      {[
        ...
        ['Premium Visual Experience', 'A venue capable of delivering lighting, staging, and production at the highest level.'],
        ['Championship Atmosphere', 'The kind of arena that makes every entrance, every match, and every final feel bigger.'],
      ].map(([title, text]) => (
        <div
          key={title}
        ...
        <section id="airport" className="border-b border-white/10">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Accessibility</div>
                <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                  Kraków Airport connects the event to the world
                </h2>
                <p className="mt-6 text-lg leading-8 text-white/75">
                  Fast international access is one of Kraków’s biggest advantages. The airport makes travel easy for athletes, coaches, media, sponsors, and fans coming from across Europe and beyond.
                </p>
                <p className="mt-4 text-base leading-8 text-white/65">
                  The short transfer time between the airport and the city center helps turn the entire championship trip into a smooth, premium event experience.
                </p>
              </div>
        ...
        <section id="hotels" className="border-b border-white/10">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Accommodation</div>
                <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                  Strong hotel base for athletes and fans
                </h2>
                <p className="mt-6 text-lg leading-8 text-white/75">
                  Kraków offers a wide accommodation range for every type of visitor — from premium hotels to practical options for teams, families, and international supporters.
                </p>
                <p className="mt-4 text-base leading-8 text-white/65">
                  This makes the city ideal for a multi-day championship experience with thousands of incoming guests.
                </p>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div key={title} className="rounded-[2rem] border border-white/10 bg-black/60 p-6 backdrop-blur-xl">
                    <div className="text-lg font-black uppercase">{title}</div>
                    <p className="mt-3 text-sm leading-7 text-white/65">{text}</p>
                  </div>
                ))}
        ...
        <section id="tickets" className="border-b border-white/10">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Tickets</div>
              <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                Be there when history is made
              </h2>
              <p className="mt-6 text-lg leading-8 text-white/75">
                Secure your place for one of the biggest weekends in grappling. Premium seats, world-level action, and a live arena experience built for true fans of the sport.
              </p>
            </div>
            ...
            <div className="mt-10 rounded-[2rem] border border-amber-400/30 bg-gradient-to-r from-amber-400/15 to-white/[0.04] p-8 shadow-2xl shadow-black/30">
              <div className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-300">Official Ticket Info</div>
              <h3 className="mt-3 text-3xl font-black uppercase">Tickets available via official sales partner</h3>
...
>
  Tickets
        ...
        <section id="sponsors" className="border-b border-white/10 bg-white/[0.02]">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              <div className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-400">Sponsors</div>
              <h2 className="mt-4 text-4xl font-black uppercase leading-tight sm:text-5xl">
                Align your brand with a global combat sports property
              </h2>
              <p className="mt-6 text-lg leading-8 text-white/75">
                ADCC offers access to a deeply engaged international audience through premium event branding, digital exposure, social media integration, and direct association with the biggest stage in the sport.
              </p>
            </div>

            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              {sponsorTiers.map((tier) => (
                <div key={tier.name} className="rounded-[2rem] border border-white/10 bg-black/60 p-7 backdrop-blur-xl">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-white/75">
                  For partnerships, media opportunities, and event communication, use the
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
                <div className="space-y-5 text-sm leading-7 text-white/75">
                  <div>
                    <div className="text-white/45 uppercase tracking-[0.2em] text-xs">Email</div>
      ...
      <footer className="border-t border-white/10 bg-black/80">
        <div className="flex justify-center gap-6 pt-6">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 text-white/70 hover:text-amber-400 transition"
          >
